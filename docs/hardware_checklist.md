...
| Photoresistor ADC reading | Tested / Inconclusive | GPIO 3 | `firmware/tests/test_photoresistor.py` | Thonny repeat test: exposed average 6543.4; covered average 6546.6; difference 3.2. No clear light response observed. |
