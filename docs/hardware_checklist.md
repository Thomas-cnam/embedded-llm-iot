...
| RGB LED control | Tested / Working | GPIO 10 / GPIO 11 / GPIO 21 | `firmware/tests/test_rgb_led.py` | Manual Thonny test successful: red, green, blue, white, and off states worked; ACTIVE_LOW = False; no error observed. |
